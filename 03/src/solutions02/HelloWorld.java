...
public class HelloWorld {
	...
	final static double lossrate  = 0.2;  // 0 means all messages are delivered, 1 none 
	final static double delay_min = 0.1;  // min delay in seconds 
	final static double delay_max = 3.0;  // max delay in seconds
	...
	static Channel senderChannel = 	new AlternatingBitSenderProxy(
										new RandomDelayChannelProxy (
											new LossyChannelProxy (
												p.gehtLeft(), lossrate
											), delay_min, delay_max
										)
									);
